...
@section('content')
	<div class="container home term">
		...
		<div class="row12">
			<div class="line1 flex align-items-center">Trang trước : <a href="{{ url('/ve-chung-toi') }}">Giới thiệu phòng khám</a></div>
		</div>
		<div class="row13">
			<div class="comments">
				<div class="dis-table">
